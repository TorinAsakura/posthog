...
Getting denied is recoverable but wasteful: the caller learns nothing about *when* the budget frees, so it backs off blind, and the budget it already spent stays spent.
