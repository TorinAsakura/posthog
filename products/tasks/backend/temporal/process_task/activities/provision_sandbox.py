...
def _dev_stack_preview_resources(ctx: TaskProcessingContext) -> dict[str, float | int]:
    # Cores are left alone: the preview only runs on the VM runtime, whose default is
    # already VM_SANDBOX_CPU_CORES. The dev stack needs the memory headroom though.
